...
import user from '../img/people.png';
            ...
            <div className="row ">
               ...
               <div className="col-md-4 ">
                    ...
                    <ul className="list-group">
                        <li className="list-group-item"><i className="glyphicon glyphicon-star" style={{color:'#f88100'}}></i> Jane, in the age group 20-25 lives in California.</li>
