        ...
        return(
            ...
            <div className="row ">
               ...
               <div className="col-md-4 ">
                    ...
                    <div className="panel-heading">Sarah's Bio</div>
                    
                    <ul className="list-group">
                        <li className="list-group-item"><i className="glyphicon glyphicon-star" style={{color:'#f88100'}}></i> Sarah, in the age group 20-25 lives in California.</li>
